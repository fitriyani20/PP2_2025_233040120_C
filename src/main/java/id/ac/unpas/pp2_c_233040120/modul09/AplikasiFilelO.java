 ...
 */
package id.ac.unpas.pp2_c_233040120.modul09;
 ...
 */
public class AplikasiFilelO extends JFrame {
   //Komponen UI
    ...
    public AplikasiFilelO(){
        ...
        btnSaveBinary = new JButton("Simpan Config (Binary)"); //Latihan 3 simpan
        btnLoadBinary = new JButton("Muat Config (Binary)"); // Latihan 1 muat binary (Data Stream)
        
        buttonPanel.add(btnOpenText);
        buttonPanel.add(btnSaveText);
        buttonPanel.add(btnAppendText); // Latihan 4 tombol baru tambahkan ke panel
        ...
        //1. MEMBACA FILE TEKS (TEXS STREAM)
        ...
        //btnAppendText.addActionListener(e -> appendFileTeks());  // Latihan 4
         ...
         // LATIHAN 2 → langsung muat last_notes.txt jika ada
        muatNotesOtomatis();
    }
    ...
    //Contoh: menulis file teks menggunakan Try-With-Recources (lebih modern)
    ...
    public static void main(String[] args){
        SwingUtilities.invokeLater(() -> {
            new AplikasiFilelO().setVisible(true);
        });
    }    
}
